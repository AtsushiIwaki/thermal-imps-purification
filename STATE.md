...
- A publication license, repository owner/remote, release tags, and registry publication remain
  undecided. The prepared workflow has not run on GitHub, and Linux execution is unverified.
...
the affected interface. For publication, select the license and hosting destination, configure a
